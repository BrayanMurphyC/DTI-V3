...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post articulos_url, params: { articulo: { body: @articulo.body, tags: @articulo.tags, title: @articulo.title } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { body: @articulo.body, tags: @articulo.tags, title: @articulo.title } }
